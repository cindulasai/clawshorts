...
Usage:
    python3 clawshorts-healthcheck.py 192.168.1.100 &
    # Or run via cron: */5 * * * * python3 /path/to/clawshorts-healthcheck.py 192.168.1.100
"""
...
def _log(msg: str) -> None:
    """Append a timestamped message to the healthcheck log."""
